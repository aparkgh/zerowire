...
Midway during the project I decided that it would be easier to create two mice. I overcame many complications and revisions, going over three mouse shells, different switches, signing an NDA to acquire a confidential datasheet, and heading into this project was fun but ultimately stressful as I only really had AI to guide me. A lot of time and effort and money was put into efforts that would end up not being incorporated in the project. However, I don't think this as a waste of time. I learnt many facets aobut project management and I come out of this experience grateful that I went through all of these revisions and I am able to share them with people today. If you have the time and money, I would actually encourage you to attempt this project guideless also. Many, many unique challenges later, I'm slightly disappointed that my custom design would end up being the 'throwaway' design but nevertheless I'm glad that my initial goal of creating a wireless mouse using type c and 2.4Ghz RF was possible in the end. This was actually the approach that Optimum used in his earlier revisions of the zeromouse project when it was in it's modkit phase, which was the initial inspiration of the video. I was aware of this but purposefully avoided a 'modkit' approach because I really wanted to DIY the entire approach. However this proved to be too difficult as I'm not too experienced in PCB design, meaning that figuring out which parts to buy and which parts are compatible with the challenge of then finding a pcb that would somewhat compatible and a shell that someone made for that PCB etc. I did end up using some of my components but most of them like the raspberry pi pico and the custom breakout board for the paw3395 ended up being unused for the final product (only for initial testing). Regardless, the rundown of the two mice is; one would remain with the original goal of the custom built wireless mouse with USB-C and 2.4GHz RF, and the other would be a wired mouse with microusb. The original components that I had used was initially for a wireless design, however I found that too many complications arose regarding implementing all of the mouse features (like buttons and the scroll wheel). So, I decided to scrap most of my original design, and mod a Logitech MX Anywhere 2 as the wired version and to mod a Viper Pro V2 as the wireless version. The wired version would use the PAW3395 sensor, but I changed my mind on the switches and ordered TTC 80M switches which I will incorporate. Currently, the project is in a strange state as I am moving houses in a week and because it split into two mice and for simplciity sake for this repository I want to just keep it at the original mouse. But given all the efforts I made for the original design, I did want to complete the wired version even though it would be significantly worse. Right now I plan on moving this reflection to a readme and moving all of this current content of the readme into a 'prototype revision' at the bottom as a 'proof of concept' sort of section
...
- Custom shell .stl downloaded and reviewed in [TinkerCAD](https://www.tinkercad.com/dashboard) and [Bambu Studio](https://bambulab.com/en/download/studio) (can be downloaded [here](https://www.printables.com/model/979182-lightweight-zeromouse-inspired-logitech-mx-mouse-m/files) or in [/files](https://github.com/aparkgh/zerowire/blob/main/files/Mouse%20Mod%20Final%20V1.stl))
